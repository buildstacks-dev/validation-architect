...
1. **Layer and lane presence.** Every one of the six layers and five execution lanes is active with obligations or declared empty with a reason. The inner loop is an active test lane with an actual command. Undeclared absence is a finding.
