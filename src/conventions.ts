...
8. **Legacy headers are adapter syntax, not authority.** Explicit legacy imports may preserve family-named directories and first-comment CF/HB citations, but the public check path reads the checked model. New facts do not live in those tokens.
